...
const (
	PaymentService_Create_FullMethodName       = "/payment.v1.service.PaymentService/Create"
	PaymentService_GetByID_FullMethodName      = "/payment.v1.service.PaymentService/GetByID"
	PaymentService_ListPayments_FullMethodName = "/payment.v1.service.PaymentService/ListPayments"
)
...
func (c *paymentServiceClient) GetByID(ctx context.Context, in *GetByIDRequest, opts ...grpc.CallOption) (*GetByIDResponse, error) {
...
func (UnimplementedPaymentServiceServer) GetByID(context.Context, *GetByIDRequest) (*GetByIDResponse, error) {
...
func _PaymentService_GetByID_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PaymentServiceServer).GetByID(ctx, req.(*GetByIDRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var PaymentService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "payment.v1.service.PaymentService",
	...
	Metadata: "payment/v1/service/payment.proto",
}
